...
<div class="container" style="margin-top:30px">
  <div class="row">
     <div class="col-md-12">
     <h4 class="text-center display-4" style = "font-size:40px;">LIST OF STUDENTS</h1><br>
	       <div class="table-responsive">
	    <table class="table table-strip table-hover">
		   <thead>
           <tr><th>Name</th><th>Roll No.</th><th>Email Id</th><th>Contact No.</th><th>Attendence of <?php echo $sub;?></th></tr>
           </thead>
           <tbody>
                <?php while($row = $rs->fetch_array()){?>
                    <?php
                $s1 = "select * from subject_attendance where Status='P' and Email='$row[16]' and Subject='$sub'";
                $s2 = "select * from subject_attendance where Status='A' and Email='$row[16]' and Subject='$sub'";
                $rs1 = $con->query($s1);
                $pr = $rs1->num_rows;
                $rs2 = $con->query($s2);
                $ab = $rs2->num_rows;
...
<div class = "row" style = "margin-bottom:100px;" >
    ...
    <div class = "col-md-6" style = "text-align:center;">
        <a class ="btn button mt-3" href = "ShowStudentForm.php?email=<?php echo $e;?>" role = "button" >Back</a>
    </div>
</div>
