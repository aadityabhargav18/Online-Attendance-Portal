...
<p class = "text-center text-danger"><?php 
	...
	<div class="container" style="margin-top: 30px">
		<div class="row">
			<div class="col-md-2"></div>
			<div class = "col-md-8">
            <h4 class = "display-4" style="font-size:40px;text-align: center;">ENTER DETAILS TO UPDATE MAPPING</h4>
			<form class = "mt-5" action="updatemapstu_save.php?e=<?php echo $email;?>" method="post">
