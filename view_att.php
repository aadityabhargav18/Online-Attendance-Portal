<?php
    ...
    include("view_attendance_save.php");

    $sq = "select * from subject_attendance where Branch = '$branch'";
	...
	<div class="container" style="margin-top: 50px">
		<div class="row">
			...
			<form action="view_attendance_save.php?student_email=<?php echo $e;?>" method="post">
                <h4 class = "display-4" style="font-size:40px;text-align: center;">Welcome - <?php echo $row[0];?></h4>				
               
                <table class="table table-responsive mt-4">
                    <tr><td><b>ENTER DATE : </b></td><td><b>FROM :</b></td><td><input type = "date" name = "start"class = "form-control"></td><td><b>TO : </b></td><td><input type = "date" class = "form-control" name = "end"></td></tr>
                </table>
