...
<p class = "text-danger text-center"><?php 
  ...
  <h4 class="display-3 text-center" style = "font-size:40px;">ATTENDENCE DETAILS</h4><hr><br>
  <form action="MarkAttendenceData.php?email=<?php echo $em; ?>" method="post">
  <div class="form-row">
  <div class="form-group col-6">
     ...
     <div class = "row" style = "margin-bottom:100px;" >
            ...
            <div class = "col-md-6" style = "text-align:center;" >
                <button type="submit" name = "view" class="btn button mt-3">GO</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
