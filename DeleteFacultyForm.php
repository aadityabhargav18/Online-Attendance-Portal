...
<div class="container-fluid cont">
  ...
  <h4 class="display-4 text-center" style = "font-size:40px;">DELETE FACULTY</h4><hr><br>
  <form action="DeleteFacultyData.php?e=<?php echo $email;?>" method="post">
  <div class="form-row">
    <div class = "col-md-1"></div>
     <div class="form-group col-5">
	 <input type="email" class= "form-control" name="Femailid" id="Femail" placeholder="Enter Faculty Email Id" required>
     </div>
     <div class="form-group col-5">
	 <input type="text" class= "form-control" name="Fid" id="Fid" placeholder="Enter Faculty Id" required>
     </div>
     </div>
