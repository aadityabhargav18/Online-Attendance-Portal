...
?>
	<div class="container" style="margin-top: 50px">
		<div class="row">
			<div class="col-md-2"></div>
			<div class = "col-md-8">
			<form action="delhod_save.php?email=<?php echo $e;?>" method="post">
				<h4 class = "display-4"style="text-align: center;font-size:40px;">ENTER DETAILS TO DELETE HOD</h4>
				
                <div class = "row">
                    <div class = "col-md-1"></div>
                    <div class = "col-md-11">
                    <table class="table table-responsive" style="margin-top: 20px">
                        <tr><td>HOD-Id</td><td><input type="text" name="id" class="form-control" required></td><td>Email-Id</td><td><input type="email" name="dob" class="form-control" required></td></tr>
                    </table>
                    </div>
                </div>	
