...
<p class = "text-center text-danger"><?php 
	...
	<div class="container" style="margin-top: 50px">
		<div class="row">
			<div class="col-md-2"></div>
			<div class = "col-md-8">
			<form action="updateprofile_admin.php?email=<?php echo $e;?>" method="post">
                ...
                <div class = "row">
                    ...
                    <div class = "col-md-10">
                        <table class="table table-responsive" style="margin-top: 20px;width:100%">
                            <tr><td><b>NAME :- </b></td><td> <?php  echo $rw[0];?></td><td><b>EMAIL - ID :- </b></td><td> <?php  echo $rw[1];?></td></tr>
                            <tr><td><b>MOBILE NUMBER :- </b></td><td> <?php  echo $rw[2];?></td></tr>
                        </table>
                    </div>
                </div>
